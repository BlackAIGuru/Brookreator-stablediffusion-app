...
import 'q_r_startdemo_model.dart';
export 'q_r_startdemo_model.dart';

class QRStartdemoWidget extends StatefulWidget {
  const QRStartdemoWidget({super.key});

  @override
  _QRStartdemoWidgetState createState() => _QRStartdemoWidgetState();
}

class _QRStartdemoWidgetState extends State<QRStartdemoWidget>
    with TickerProviderStateMixin {
  late QRStartdemoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QRStartdemoModel());
