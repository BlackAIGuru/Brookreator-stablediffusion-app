...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    brookreatorAuthUserSubject.add(
      BrookreatorAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BrookreatorAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BrookreatorAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BrookreatorAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    brookreatorAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
BrookreatorAuthUser? currentUser;
